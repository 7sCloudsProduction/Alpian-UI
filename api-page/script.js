...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const populatePageContent = () => {
        ...
        const creator = settings.apiSettings?.creator || '7sClouds';

        setPageContent(DOM.pageTitle, settings.name, "7sClouds APIs");
        ...
        if (DOM.apiLinksContainer) {
            ...
            const defaultLinks = [{ url: "https://github.com/7sCloudsProduction", name: "Lihat di GitHub", icon: "fab fa-github" }];
